...
class TodolistViewItem extends JViewLegacy
{
    ...
    public function display($tpl = null)
    {
     ...
     //if below codeline is active then it will show the error    'Call to undefined method TodolistHelpersTodolist::getActions()'
  
  
   //$canDo = TodolistHelpersTodolist::getActions();
   
   
   //and if this is not active then this is giving the error' Layout default not found.'
