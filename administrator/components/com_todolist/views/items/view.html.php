 ...
 protected function addToolbar()
   {
        ...
        //if this line is active the it is showing the error 'Call to undefined method TodolistHelpersTodolist::getActions()'
        
 // $canDo = TodolistHelpersTodolist::getActions();
 
 // if this line is not active then it  is showing the error 'Call to a member function get() on null'
